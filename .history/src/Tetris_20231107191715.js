...
export class GFX {
	...
	draw_ui_all(piece_counter, queue, score) {
		...
		this.draw_ui_text("TetrisJS", 30, this.ui_offset + (this.ui_width / 4), 30);
		this.draw_ui_stats(piece_counter);
		this.draw_ui_queue(queue);
		this.draw_ui_text("Made by Hoswoo", 20, this.ui_offset + (this.ui_width / 1.5), bg_canvas.height - 50);
